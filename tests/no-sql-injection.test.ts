...
ruleTester.run('no-sql-injection', rule, {
  valid: [
    { code: readFileSync('tests/target-files/no-sql-injection/safe.js', 'utf-8') },
  ...
  invalid: [
    { code: readFileSync('tests/target-files/no-sql-injection/unsafe-inline.js', 'utf-8'), errors: [{ messageId: 'error' }] },
    { code: readFileSync('tests/target-files/no-sql-injection/unsafe-variable.js', 'utf-8'), errors: [{ messageId: 'error' }] },
    { code: readFileSync('tests/target-files/no-sql-injection/unsafe-inline-template.js', 'utf-8'), errors: [{ messageId: 'error' }] },
    { code: readFileSync('tests/target-files/no-sql-injection/unsafe-variable-template.js', 'utf-8'), errors: [{ messageId: 'error' }] },
  ],
});
